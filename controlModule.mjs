    ...
    handleNextStep() {
        ...
        if (this.sequence1Index < sequence1.length) {
            if (sequence1[this.sequence1Index] === sequence2[this.sequence2Index]) {
                ...
                // ici, correction du != en !== (simplement syntaxique)
                if (this.sequence2Index !== 0) {
                    // si sequence2Index est pas égal à 0 on réinitialise sequence2Index et on revient en arrière sur sequence1Index
                    this.sequence1Index = this.sequence1Index - (this.sequence2Index - 1);
                    this.sequence2Index = 0; // là du coup on remet sequence2Index à 0
                } else {
                    // et du coup si sequence2Index est égal à 0 on avance juste sur sequence1Index
                    this.sequence1Index++;
                }
            }
            this.updateVisualization();
